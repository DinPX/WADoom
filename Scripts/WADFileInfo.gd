...
onready var titlepic := $Info/Details/TitlePic
onready var title := $Info/Details/Title
...
func scanForString(string, search_size):
	var sub = data.subarray(pos,pos+(search_size - 1))
